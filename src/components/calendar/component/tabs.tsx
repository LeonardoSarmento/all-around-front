'use client';
import { ColumnsIcon, DashboardIcon, GridIcon } from '@radix-ui/react-icons';
    ...
    <div className="flex h-10 w-full items-center justify-center gap-2 sm:w-[240px]">
      <div className="inline-flex h-full w-full items-center justify-between rounded-md border border-input bg-transparent p-1">
        ...
        >
          ...
          <span
            className={`transition-all duration-500 ease-in-out ${
              props.activeTab === ('month' as TabTypes) ? 'max-w-xs opacity-100' : 'max-w-0 overflow-hidden opacity-0'
            }`}
          >
            Week
          </span>
        ...
        >
          ...
          <span
            className={`transition-all duration-500 ease-in-out ${
              props.activeTab === 'year' ? 'max-w-xs opacity-100' : 'max-w-0 overflow-hidden opacity-0'
            }`}
          >
            Year
          </span>
